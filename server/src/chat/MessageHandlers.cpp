...
drogon::Task<chat::InitialAuthResponse> MessageHandlers::handleAuthInitial(const std::shared_ptr<WsData>& wsData, const chat::InitialAuthRequest& req) {
...
drogon::Task<chat::InitialRegisterResponse> MessageHandlers::handleRegisterInitial(const std::shared_ptr<WsData>& wsData, const chat::InitialRegisterRequest& req) {
...
drogon::Task<chat::AuthResponse> MessageHandlers::handleAuth(const std::shared_ptr<WsData>& wsData, const chat::AuthRequest& req) {
...
drogon::Task<chat::RegisterResponse> MessageHandlers::handleRegister(const std::shared_ptr<WsData>& wsData, const chat::RegisterRequest& req) {
...
drogon::Task<chat::SendMessageResponse> MessageHandlers::handleSendMessage(const std::shared_ptr<WsData>& wsData, const chat::SendMessageRequest& req) {
...
drogon::Task<chat::JoinRoomResponse> MessageHandlers::handleJoinRoom(const std::shared_ptr<WsData>& wsData, const chat::JoinRoomRequest& req, IRoomService& room_service) {
...
drogon::Task<chat::LeaveRoomResponse> MessageHandlers::handleLeaveRoom(const std::shared_ptr<WsData>& wsData, const chat::LeaveRoomRequest&, IRoomService& room_service) {
...
drogon::Task<chat::GetRoomsResponse> MessageHandlers::handleGetRooms(const std::shared_ptr<WsData>& wsData, const chat::GetRoomsRequest&) {
...
drogon::Task<chat::CreateRoomResponse> MessageHandlers::handleCreateRoom(const std::shared_ptr<WsData>& wsData, const chat::CreateRoomRequest& req) {
...
drogon::Task<chat::GetMessagesResponse> MessageHandlers::handleGetMessages(const std::shared_ptr<WsData>& wsData, const chat::GetMessagesRequest& req) {
...
drogon::Task<chat::LogoutResponse> MessageHandlers::handleLogoutUser(const std::shared_ptr<WsData>& wsData, IRoomService& room_service) {
