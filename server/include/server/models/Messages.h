...
class Messages
{
  public:
    struct Cols
    {
        ...
        static const std::string _message_text;
    ...
    /**  For column message_text  */
    ///Get the value of the column message_text, returns the default value if the column is null
    const std::string &getValueOfMessageText() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getMessageText() const noexcept;
    ///Set the value of the column message_text
    void setMessageText(const std::string &pMessageText) noexcept;
    void setMessageText(std::string &&pMessageText) noexcept;
