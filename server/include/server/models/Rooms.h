...
class Rooms
{
  public:
    ...
    /**  For column room_name  */
    ///Get the value of the column room_name, returns the default value if the column is null
    const std::string &getValueOfRoomName() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getRoomName() const noexcept;
    ///Set the value of the column room_name
    ...
    void getOwner(const drogon::orm::DbClientPtr &clientPtr,
                  ...
                  const drogon::orm::ExceptionCallback &ecb) const;
    std::vector<std::pair<Users,RoomMembership>> getUsers(const drogon::orm::DbClientPtr &clientPtr) const;
