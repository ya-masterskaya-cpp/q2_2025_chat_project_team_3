...
class UserRoomRoles
{
  public:
    struct Cols
    {
        ...
        static const std::string _role_type;
    };
     ...
     */
    explicit UserRoomRoles(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserRoomRoles(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserRoomRoles(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    UserRoomRoles() = default;
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<UserRoomRoles, true, false>;
    friend drogon::orm::BaseBuilder<UserRoomRoles, false, true>;
    friend drogon::orm::BaseBuilder<UserRoomRoles, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UserRoomRoles>;
#endif
