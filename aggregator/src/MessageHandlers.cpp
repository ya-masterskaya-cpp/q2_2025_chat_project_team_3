...
drogon::Task<chat::GetServerNodesResponse> MessageHandlers::handleGetServers(const std::shared_ptr<WsData>& wsData, const chat::GetServerNodesRequest& req, IServerRegistry& registry) const {
